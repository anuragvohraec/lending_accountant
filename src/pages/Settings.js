...
import { getDb, getSettings, saveSettings, getAuditLogs, getMoneySources, getParties, getAllTransactions, getAllSourceTransactions, getCollaterals, getLedgers, getAllAuditLogs } from '../db/database.js'
...
export async function renderSettings(container, navigate) {
  ...
  const db = getDb()
  const countByPrefix = async (prefix) => {
